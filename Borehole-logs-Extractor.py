...
class QRCodeTooltip:
    ...
    def generate_qr(self):
        ...
        qr.make(fit=True)
        return qr.make_image(fill_color="#34A853", back_color="white")
...
class SampleApp(ttkb.Window):
    ...
    def __init__(self):
        ...
        # 创建输出控制台区域
        console_frame = ttkb.LabelFrame(self, text="程序输出", padding=10)
        console_frame.grid(row=0, column=4, rowspan=19, sticky=W+E+N+S, padx=10, pady=10)
