...
class SampleApp(tk.Tk):
    ...
    def new_one2one_comboboxes(
        ...
        self.comboboxes_2 = ttk.Combobox(
            self, values=("右", "下", "上", "标题"), width=5
        )
    ...
    def __init__(self):
        ...
        self.label6 = self.new_label(
            "两侧宽度增加值", required_fields_first_row + 5, 0, 1, 1
        )
        self.entry11 = self.new_entry(0, required_fields_first_row + 5, 1, 1, 1)
        self.label7 = self.new_label(
            "底部高度增加值", required_fields_first_row + 6, 0, 1, 1
        )
        self.entry12 = self.new_entry(0, required_fields_first_row + 6, 1, 1, 1)
        self.label8 = self.new_label(
            "插入点或中心点", required_fields_first_row + 7, 0, 1, 1
        )
        self.combobox6 = self.new_combobox(
            ("中心点", "插入点"), required_fields_first_row + 7, 1, 1, 1
        )
        self.label9 = self.new_label(
            "岩土描述排序方式", required_fields_first_row + 8, 0, 1, 1
        )
        self.combobox7 = self.new_combobox(
            ("A", "B", "C"), required_fields_first_row + 8, 1, 1, 1
        )
        self.label10 = self.new_label(
            "土工标贯形式", required_fields_first_row + 9, 0, 1, 1
        )
        ...
        self.entry5 = self.new_entry(
            "力学数据", required_fields_first_row + 13, 0, 1, 1
        )
        self.entry6 = self.new_entry(
            "力学数据", required_fields_first_row + 13, 1, 1, 1
        )
        self.entry7 = self.new_entry(
            "稳定水位", required_fields_first_row + 14, 0, 1, 1
        )
        self.entry8 = self.new_entry(
            "稳定水位", required_fields_first_row + 14, 1, 1, 1
        )  #'=柱状图'
        ...
        self.one2one_field_name_3 = self.new_combobox(
            ("开孔日期", "开工日期"), 3, 2, 1, 1
        )
        self.one2one_navigation_3 = self.new_combobox_with_width(
            ("右", "下", "上", "标题"), 3, 3, 1, 1
        )
        self.one2one_field_name_4 = self.new_combobox(
            ("终孔日期", "竣工日期"), 4, 2, 1, 1
        )
        ...
        self.one2one_field_name_7 = self.new_combobox(
            ("初见水位深度", "初见水位"), 7, 2, 1, 1
        )
